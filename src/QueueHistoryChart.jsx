...
export default function QueueHistoryChart({ history }) {
  return (
    <ResponsiveContainer width="100%" height="100%">
      <LineChart data={history} margin={{ top: 8, right: 12, left: -24, bottom: 0 }}>
        ...
        <Line type="stepAfter" dataKey="qUturn" name="Q_UTURN" stroke="#4db7d0" strokeWidth={2} dot={false} connectNulls={false} />
        <Line type="stepAfter" dataKey="qMain" name="Q_MAIN" stroke="#e8c45b" strokeWidth={2} dot={false} connectNulls={false} />
      </LineChart>
    </ResponsiveContainer>
  );
}
